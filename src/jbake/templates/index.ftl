	...
	<#list posts as post>
  		<#if (post.status == "published")>
  			...
  			<p>${post.date?string("dd MMMM yyyy")}</p>
                        ...
                        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.ybonnel.fr/${post.uri}" data-text="${post.title}" data-via="lhuet35" data-lang="fr">Tweeter</a>
